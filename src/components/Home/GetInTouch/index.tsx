        ...
        <section>
            <div className='container max-w-8xl mx-auto px-5 2xl:px-0'>
                <div className="relative rounded-t-2xl overflow-hidden">
                    ...
                    >
                        <source src="https://videos.pexels.com/video-files/33739602/14324787_1920_1080_30fps.mp4" type="video/mp4" />
                    </video>
                    
                    <div className="lg:py-92 md:py-15 py-38"> {/* To Shade the Video bg-black/30 */}

    ...
    return (
        <section>
            <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
                <div className='flex justify-between md:items-end items-start mb-10 md:flex-row flex-col'>
                    <div>
                        <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2">
                            <Icon icon="mdi:om" className="text-2xl text-primary" aria-label="Home icon" />
                        ...
                        <p className='text-dark/50 dark:text-white/50 text-xm'>
                            Stay connected with our latest programs, yatras, and service milestones.
                        </p>
                    </div>
                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-12">
                    {posts.map((blog, i) => (
